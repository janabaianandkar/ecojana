    ...
    <section class="product-details spad">
        <div class="container">
            <div class="row">
                ...
                $prw=mysqli_fetch_assoc($pres);
                ?>
                <div class="col-lg-6">
                    <div class="product__details__pic">
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-hash="product-1" class="product__big__img" src="dashboard/imgs/<?php echo $prw['img']; ?>" 
                ...
                <div class="col-lg-6">
                    ...
                    <form method="post" action="add-to-cart.php">
                        ...
                        <div class="product__details__price">$ <?php echo $prw['price']; ?> </div>
