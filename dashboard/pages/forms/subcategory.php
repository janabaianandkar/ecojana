...
if(isset($_POST['btn']))
{
    ...
    {
        $sql="insert into subcategory(cid,sname,img)values('$cid','$name','$filename')";
        ...
        {
            echo "<script>alert('SubCategory not added successfully...')</script>";
        }
    }
}
?>
                ...
                <div class="card-body">
                  ...
                  <label for="exampleInputUsername1">Select Category</label><br>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="SubCategory Name"
                      name="name">
                    </div>
                    <div class="form-group">
