...
if(isset($_POST['btn']))
{
    ...
    {
        $sql="update product set pname='$name',img='$filename',price='$pri' where id=$id";
        ...
        {
            echo "<script>alert('Product not updated successfully...')
            window.location.href='producttable.php'</script>";
        }
    }
    }
    ...
    {
        $sql="update product set pname='$name',price='$pri' where id=$id";
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                ...
                <span class="nav-profile-name"><?php each $_SESSION['ename']; ?></span>
              </a>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Product form</h4><br>
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                  <label for="exampleInputUsername1">Select SubCategory</label><br>
                    <select name='sid'>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" value="<?php echo $rw1[4]; ?>"
                      name="pri">
                    </div>
