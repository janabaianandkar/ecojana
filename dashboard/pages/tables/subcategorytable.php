                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td><?php echo $rw[1]; ?></td>
                          <td class="py-1">
                            <img src="../../imgs/<?php echo $rw[3]; ?>" alt="image"/>
                          </td>
                          <td><?php echo $rw[2]; ?></td>
                          <td><a href="subcategoryupdate.php?id=<?php echo $rw[0]; ?>" style="color:#008e00; font-weight:bold;">Update</a></td>
                          <td><a href="subcategorydelete.php?id=<?php echo $rw[0]; ?>" style="color:red; font-weight:bold;">Delete</a></td>
                        </tr>
                        <?php
                        }
                        ?>
