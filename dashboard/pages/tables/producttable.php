                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td><?php echo $rw[1]; ?></td>
                          ...
                          <td><?php echo $rw[2]; ?></td>
                          <td><?php echo $rw[4]; ?></td>
                          <td><a href="productupdate.php?id=<?php echo $rw[0]; ?>" style="color:#008e00; font-weight:bold;">Update</a></td>
                          <td><a href="productdelete.php?id=<?php echo $rw[0]; ?>" style="color:red; font-weight:bold;">Delete</a></td>
                        </tr>
                        <?php
                        }
                        ?>
