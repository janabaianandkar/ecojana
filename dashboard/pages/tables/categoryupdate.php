...
if(isset($_POST['btn']))
{
    ...
    {
        $sql="update category set cname='$name',img='$filename' where id='$id'";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Category form</h4><br>
                  
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Category Name</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" value="<?php echo $rw[1]; ?>"
                      name="name">
                    </div>
                    <div class="form-group">
                    <img src="../../imgs/<?php echo $rw[2]; ?>" width=150 height=120><br><br>
